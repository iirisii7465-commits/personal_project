...
<header id="header">
    ...
    <nav class="menu">
        <ul>
            ...
            <li>
                <a href="${pageContext.request.contextPath}/index.jsp#features">
                    特徴
                </a>
            </li>

            <li>
                <a href="${pageContext.request.contextPath}/index.jsp#pricing">
                    料金プラン
                </a>
            </li>
