...
<script
	src="${pageContext.request.contextPath}/member/login_function.js" defer></script>
				...
				<div class="search_container">
						...
						<div class="search_box_1">
							...
							<div class="select_box">
								...
								<select class="select" name="t_select">
									...
									<option value="m.title"
										<c:if test="${select eq 'm.title'}">selected</c:if>>
										タイトル</option>

									<option value="b.board_content"
										<c:if test="${select eq 'b.board_content'}">selected</c:if>>
										内容</option>
								</select>
							...
							<div class="text">
								...
								<input type="text" class="text_box" name="t_search" value="${search}">
			...
			============================== -->
				...
				<div class="content_boxing">
					...
					<c:forEach items="${boardList}" var="board">
						...
						<div class="content"   onclick="location.href='${pageContext.request.contextPath}/Notice?t_gubun=view&t_board_no=${board.board_no}'">
							...
							<div class="content_info">
								...
								<div class="content_text_info">
									...
									<!-- 곡명 -->
									<span class="content_title"> 曲名：${board.title} </span>


									<!-- 작성자 -->
									<span class="content_author"> 投稿者：${board.id} </span>
